...
Set `GEMINI_HTTP_TIMEOUT_MS=60000` (default) to keep each hosted advisor call
bounded while allowing Gemma 4 thinking responses to complete; on a timeout
the engine proceeds to its fallback path.
